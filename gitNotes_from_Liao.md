...
```
#### 从Github远程仓库中删除文件夹或者文件
**在Github上面只能删除仓库,却无法删除文件或者文件夹,所以只可以通过命令来解决**

---
1. 首先进入本地master文件下面,打开命令窗口,
...
* 本地项目的target文件夹不受操作的影响,删除的只是远程仓库的target,可放心删除<br/>
* 每次增加文件或者删除文件,都要commit然后直接git push -u orgin master,就可以同步到github上面了
